...
file.HC ──lex──▶ tokens ──preprocess──▶ tokens ──parse──▶ Program ──emit──▶ .ll/.c/.js ──build──▶ exe
              (#include,#define,#ifdef)         (AST+lowering)        (external toolchain)
```
...
* `runtime/rt.c`, `runtime/rt.js` — the runtime; `runtime/prelude.hc`
  declares it to the compiler. All three are embedded via
  `src/embed.c`, generated by `tools/file2c` in the Makefile.
