// mhc #exe prelude: compiled in front of every #exe{} block.
// The block runs inside the compiler process; these externs resolve
// against symbols the mhc binary exports (see src/exe.c).

// Token kinds, same values as TokenKind in src/mhc.h.
#define TK_EOF   0
#define TK_ID    1
#define TK_NUM   2
#define TK_FNUM  3
...
// Accepted for TempleOS compatibility; mhc's codegen has no such
