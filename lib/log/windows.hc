...
#define LOG_WIN_SHARE_READWRITE 0x3
...
{
  U8 *handle = CreateFileA(path, LOG_WIN_APPEND_DATA, LOG_WIN_SHARE_READWRITE,
    NULL, LOG_WIN_OPEN_ALWAYS, LOG_WIN_ATTR_NORMAL, NULL);
